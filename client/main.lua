        ...
        if isLoggedIn and ClosestHouse ~= nil then
            if InApartment then
                ...
                if CurrentDoorBell ~= 0 then
                    if(GetDistanceBetweenCoords(pos.x, pos.y, pos.z, Apartments.Locations[ClosestHouse].coords.enter.x - CurrentXOffset + POIOffsets.exit.x - 2.76, Apartments.Locations[ClosestHouse].coords.enter.y - POIOffsets.exit.y, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentZOffset + POIOffsets.exit.z, true) < 1.2)then
                        QBCore.Functions.DrawText3D(Apartments.Locations[ClosestHouse].coords.enter.x - CurrentXOffset + POIOffsets.exit.x - 2.76, Apartments.Locations[ClosestHouse].coords.enter.y - POIOffsets.exit.y, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentZOffset + POIOffsets.exit.z + 0.1, '~g~G~w~ - Open door')
                ...
                --exit
                if(GetDistanceBetweenCoords(pos.x, pos.y, pos.z, Apartments.Locations[ClosestHouse].coords.enter.x - CurrentXOffset + POIOffsets.exit.x - 2.76, Apartments.Locations[ClosestHouse].coords.enter.y - POIOffsets.exit.y, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentZOffset + POIOffsets.exit.z, true) < 3)then
                    QBCore.Functions.DrawText3D(Apartments.Locations[ClosestHouse].coords.enter.x - CurrentXOffset + POIOffsets.exit.x - 2.76, Apartments.Locations[ClosestHouse].coords.enter.y - POIOffsets.exit.y, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentZOffset + POIOffsets.exit.z, '~g~E~w~ - Leave apartment')
                    if IsControlJustPressed(0, Keys["E"]) then
                        LeaveApartment(ClosestHouse)
                    end
                end
                --stash
                if(GetDistanceBetweenCoords(pos.x, pos.y, pos.z, Apartments.Locations[ClosestHouse].coords.enter.x - CurrentXOffset + POIOffsets.stash.x - 4.532, Apartments.Locations[ClosestHouse].coords.enter.y - POIOffsets.stash.y, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentZOffset + POIOffsets.stash.z, true) < 1.2)then
                    QBCore.Functions.DrawText3D(Apartments.Locations[ClosestHouse].coords.enter.x - CurrentXOffset + POIOffsets.stash.x - 4.532, Apartments.Locations[ClosestHouse].coords.enter.y - POIOffsets.stash.y, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentZOffset + POIOffsets.stash.z, '~g~E~w~ - Stash')
                    if IsControlJustPressed(0, Keys["E"]) then
                ...
                elseif (GetDistanceBetweenCoords(pos.x, pos.y, pos.z, Apartments.Locations[ClosestHouse].coords.enter.x - CurrentXOffset + POIOffsets.stash.x - 4.532, Apartments.Locations[ClosestHouse].coords.enter.y - POIOffsets.stash.y, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentZOffset + POIOffsets.stash.z, true) < 3)then
                    QBCore.Functions.DrawText3D(Apartments.Locations[ClosestHouse].coords.enter.x - CurrentXOffset + POIOffsets.stash.x - 4.5324, Apartments.Locations[ClosestHouse].coords.enter.y - POIOffsets.stash.y, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentZOffset + POIOffsets.stash.z, 'Stash')
                end
                --outfits
                if(GetDistanceBetweenCoords(pos.x, pos.y, pos.z, Apartments.Locations[ClosestHouse].coords.enter.x - CurrentXOffset + POIOffsets.clothes.x - 3.2, Apartments.Locations[ClosestHouse].coords.enter.y - POIOffsets.clothes.y, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentZOffset + POIOffsets.clothes.z, true) < 1.2)then
                    QBCore.Functions.DrawText3D(Apartments.Locations[ClosestHouse].coords.enter.x - CurrentXOffset + POIOffsets.clothes.x - 3.2, Apartments.Locations[ClosestHouse].coords.enter.y - POIOffsets.clothes.y, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentZOffset + POIOffsets.clothes.z, '~g~E~w~ - Outfits')
                    if IsControlJustPressed(0, Keys["E"]) then
                        TriggerEvent('qb-clothing:client:openOutfitMenu')
                    end
                elseif (GetDistanceBetweenCoords(pos.x, pos.y, pos.z, Apartments.Locations[ClosestHouse].coords.enter.x - CurrentXOffset + POIOffsets.clothes.x - 3.2, Apartments.Locations[ClosestHouse].coords.enter.y - POIOffsets.clothes.y, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentZOffset + POIOffsets.clothes.z, true) < 3)then
                    QBCore.Functions.DrawText3D(Apartments.Locations[ClosestHouse].coords.enter.x - CurrentXOffset + POIOffsets.clothes.x - 3.2, Apartments.Locations[ClosestHouse].coords.enter.y - POIOffsets.clothes.y, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentZOffset + POIOffsets.clothes.z, 'Outfits')
                end
                --logout
                if(GetDistanceBetweenCoords(pos.x, pos.y, pos.z, Apartments.Locations[ClosestHouse].coords.enter.x - CurrentXOffset + POIOffsets.logout.x + 3.8394, Apartments.Locations[ClosestHouse].coords.enter.y + POIOffsets.logout.y, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentZOffset + POIOffsets.logout.z, true) < 1.5)then
                    QBCore.Functions.DrawText3D(Apartments.Locations[ClosestHouse].coords.enter.x - CurrentXOffset + POIOffsets.logout.x + 3.8394, Apartments.Locations[ClosestHouse].coords.enter.y + POIOffsets.logout.y, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentZOffset + POIOffsets.logout.z, '~g~E~w~ - Log out')
                    if IsControlJustPressed(0, Keys["E"]) then
                        TriggerServerEvent('qb-houses:server:LogoutLocation')
                        exports.mumble_voip_fivem:removePlayerFromRadio()
                    end
                elseif (GetDistanceBetweenCoords(pos.x, pos.y, pos.z, Apartments.Locations[ClosestHouse].coords.enter.x - CurrentXOffset + POIOffsets.logout.x + 3.8394, Apartments.Locations[ClosestHouse].coords.enter.y + POIOffsets.logout.y, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentZOffset + POIOffsets.logout.z, true) < 3)then
                    QBCore.Functions.DrawText3D(Apartments.Locations[ClosestHouse].coords.enter.x - CurrentXOffset + POIOffsets.logout.x + 3.8394, Apartments.Locations[ClosestHouse].coords.enter.y + POIOffsets.logout.y, Apartments.Locations[ClosestHouse].coords.enter.z - CurrentZOffset + POIOffsets.logout.z, 'Log out')
                end
            else
                local pos = GetEntityCoords(GetPlayerPed(-1))
...
function EnterApartment(house, apartmentId, new)
    ...
    openHouseAnim()
    Citizen.Wait(250)
    QBCore.Functions.TriggerCallback('apartments:GetApartmentOffset', function(zoffset, xoffset)
        if zoffset == nil or zoffset == 0 then
            QBCore.Functions.TriggerCallback('apartments:GetApartmentOffsetNewOffset', function(newzoffset, newxoffset)
                --[[ if newzoffset > 230 then
                    newzoffset = 30
                    newxoffset = newxoffset - 30
                end ]]
                CurrentZOffset = newzoffset
                CurrentXOffset = newxoffset
                TriggerServerEvent("apartments:server:AddObject", apartmentId, house, CurrentZOffset, CurrentXOffset)
                
                local coords = { x = Apartments.Locations[house].coords.enter.x - CurrentXOffset, y = Apartments.Locations[house].coords.enter.y, z = Apartments.Locations[house].coords.enter.z - CurrentZOffset}
            ...
            TriggerServerEvent("InteractSound_SV:PlayOnSource", "houses_door_open", 0.1)
            TriggerServerEvent("apartments:server:AddObject", apartmentId, house, CurrentZOffset, CurrentXOffset)
            local coords = { x = Apartments.Locations[ClosestHouse].coords.enter.x - CurrentXOffset, y = Apartments.Locations[ClosestHouse].coords.enter.y, z = Apartments.Locations[ClosestHouse].coords.enter.z - CurrentZOffset}
            data = exports['qb-interior']:CreateApartmentFurnished(coords)
...
function OutfitsLijst()
    QBCore.Functions.TriggerCallback('apartments:GetOutfits', function(outfits)
        ...
        if outfits == nil then
            QBCore.Functions.Notify("You didn\'t save any outfits...", "error", 3500)
            closeMenuFull()
        else
